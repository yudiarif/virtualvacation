(function (h, e) {
  ...
  function F(a) {
    ...
    b = new e.ShaderMaterial({ fragmentShader: b.fragmentShader, vertexShader: b.vertexShader, uniforms: b.uniforms, side: e.BackSide, transparent: !0 });
    n.call(this, c, b);
    this.images = a;
    this.edgeLength = 1e4;
  ...
  function B(a, b) {
    ...
    n.call(this, c, d);
    this.src = a;
    this.options = { videoElement: document.createElement("video"), loop: !0, muted: !0, autoplay: !1, playsinline: !0, crossOrigin: "anonymous" };
  ...
  function ba(a, b) {
    ...
    function k(a) {
      if (!1 !== f.enabled && !0 !== f.noZoom && x === w.NONE) {
        ...
        0 < d
          ? ((f.object.fov = f.object.fov < f.maxFov ? f.object.fov + 1 : f.maxFov), f.object.updateProjectionMatrix())
          : 0 > d && ((f.object.fov = f.object.fov > f.minFov ? f.object.fov - 1 : f.minFov), f.object.updateProjectionMatrix());
        f.update();
        f.dispatchEvent(V);
        f.dispatchEvent(O);
        f.dispatchEvent(P);
    ...
    function m(a) {
      if (!1 !== f.enabled && !0 !== f.noKeys && !0 !== f.noRotate) {
        ...
        if (I || J || X || Y)
          (Q = !0), I && (L = -f.rotateSpeed * f.momentumKeydownFactor), J && (L = f.rotateSpeed * f.momentumKeydownFactor), X && (K = -f.rotateSpeed * f.momentumKeydownFactor), Y && (K = f.rotateSpeed * f.momentumKeydownFactor);
      }
    }
    function l(a) {
      Q = !1;
      ...
      if (!1 !== f.enabled) {
        ...
        switch (a.touches.length) {
          ...
          case 2:
            ...
            0 > T.y
              ? ((f.object.fov = f.object.fov < f.maxFov ? f.object.fov + 1 : f.maxFov), f.object.updateProjectionMatrix())
              : 0 < T.y && ((f.object.fov = f.object.fov > f.minFov ? f.object.fov - 1 : f.minFov), f.object.updateProjectionMatrix());
            y.copy(z);
            f.update();
            f.dispatchEvent(V);
            break;
    ...
    this.pan = function (a, d) {
      ...
      if (f.object instanceof e.PerspectiveCamera) {
        ...
        f.object instanceof e.OrthographicCamera
          ? (f.panLeft((a * (f.object.right - f.object.left)) / b.clientWidth), f.panUp((d * (f.object.top - f.object.bottom)) / b.clientHeight))
    ...
    this.dollyIn = function (a) {
      ...
      f.object instanceof e.PerspectiveCamera
        ? (E /= a)
        : f.object instanceof e.OrthographicCamera
        ? ((f.object.zoom = Math.max(this.minZoom, Math.min(this.maxZoom, this.object.zoom * a))), f.object.updateProjectionMatrix(), f.dispatchEvent(V))
  ...
  function ha(a) {
    ...
    d.aspect = 0.5;
    var g = new e.WebGLRenderTarget(512, 512, { minFilter: e.LinearFilter, magFilter: e.NearestFilter, format: e.RGBAFormat });
    g.scissorTest = !0;
  ...
  var r = (function (a, b) {
        ...
        for (b in this._valuesEnd)
          if (void 0 !== this._valuesStart[b]) {
            ...
            l instanceof Array
              ...
              : ("string" === typeof l && (l = "+" === l.charAt(0) || "-" === l.charAt(0) ? e + parseFloat(l) : parseFloat(l)), "number" === typeof l && (this._object[b] = e + (l - e) * c));
          }
          ...
          if (0 < this._repeat) {
            ...
            for (b in this._valuesStartRepeat)
              "string" === typeof this._valuesEnd[b] && (this._valuesStartRepeat[b] += parseFloat(this._valuesEnd[b])),
                this._yoyo && ((d = this._valuesStartRepeat[b]), (this._valuesStartRepeat[b] = this._valuesEnd[b]), (this._valuesEnd[b] = d)),
    ...
    c.Easing = {
      ...
      Elastic: {
        ...
        InOut: function (a) {
          ...
          if (1 === a) return 1;
          a *= 2;
          return 1 > a ? -0.5 * Math.pow(2, 10 * (a - 1)) * Math.sin(5 * (a - 1.1) * Math.PI) : 0.5 * Math.pow(2, -10 * (a - 1)) * Math.sin(5 * (a - 1.1) * Math.PI) + 1;
        },
      },
      Back: {
        In: function (a) {
    ...
    c.Interpolation = {
      ...
      Bezier: function (a, b) {
        for (var d = 0, g = a.length - 1, e = Math.pow, l = c.Interpolation.Utils.Bernstein, h = 0; h <= g; h++) d += e(1 - b, g - h) * e(b, h) * a[h] * l(g, h);
        return d;
      },
      CatmullRom: function (a, b) {
        ...
        return a[0] === a[d]
          ? (0 > b && (e = Math.floor((g = d * (1 + b)))), l(a[(e - 1 + d) % d], a[e], a[(e + 1) % d], a[(e + 2) % d], g - e))
          : 0 > b
  ...
  z.prototype = Object.assign(Object.create(e.Sprite.prototype), {
      ...
      if (this.getContainer()) {
        ...
        g &&
          ...
          this.mode === t.CARDBOARD || this.mode === t.STEREO
            ? ((c.display = "none"), (a.style.display = "block"), (b.style.display = "block"), (g._width = a.clientWidth), (g._height = a.clientHeight))
            : ((c.display = "block"), a && (a.style.display = "none"), b && (b.style.display = "none"), (g._width = g.clientWidth), (g._height = g.clientHeight)));
      }
    },
    onHoverEnd: function () {
      if (this.getContainer()) {
    ...
    onDualEyeEffect: function (a) {
      if (this.getContainer()) {
        ...
        a &&
          ...
          this.mode === t.CARDBOARD || this.mode === t.STEREO
            ? ((a.left.style.display = a.style.display), (a.right.style.display = a.style.display), (a.style.display = "none"))
            : ((a.style.display = a.left.style.display), (a.left.style.display = "none"), (a.right.style.display = "none")),
    ...
    translateElement: function (a, b) {
      if (this.element._width && this.element._height && this.getContainer()) {
        ...
        var m = a - g;
        var l = b - e - p;
        (this.mode !== t.CARDBOARD && this.mode !== t.STEREO) || !d.left || !d.right || (a === c.clientWidth / 2 && b === c.clientHeight / 2)
    ...
    addHoverElement: function (a, b) {
      b = void 0 === b ? 40 : b;
      this.element ||
        ((this.element = a.cloneNode(!0)), (this.element.style.display = "none"), (this.element.style.top = 0), (this.element.style.position = "absolute"), this.element.classList.add("panolens-infospot"), (this.element.verticalDelta = b));
    },
  ...
  I.prototype = Object.assign(Object.create(e.EventDispatcher.prototype), {
    ...
    createFullscreenButton: function () {
      function a() {
        d && ((c = !c), (e.style.backgroundImage = c ? 'url("' + u.FullscreenLeave + '")' : 'url("' + u.FullscreenEnter + '")'));
    ...
    createVideoControlSeekbar: function () {
      ...
      function b(a) {
        e &&
          ...
          (l = 1 < l ? 1 : 0 > l ? 0 : l),
          f.setProgress(l),
          g.dispatchEvent({ type: "panolens-viewer-handler", method: "setVideoCurrentTime", data: l }));
      }
      function c(a) {
        a.stopPropagation();
        e = !1;
        ...
        if (((b = a), a.dispatchEvent)) {
          ...
          a.dispatchEvent({
            ...
            method: function (a, b, c) {
              this.dispatchEvent({ type: "panolens-viewer-handler", method: "tweenControlCenter", data: [a, b, c] });
            }.bind(this),
          });
        }
  ...
  B.prototype = Object.assign(Object.create(n.prototype), {
    ...
    load: function () {
      ...
      k.addEventListener(
        "ended",
        function () {
          c || (this.resetVideo(), this.dispatchEvent({ type: "panolens-viewer-handler", method: "updateVideoPlayButton", data: !0 }));
        }.bind(this),
        !1
      );
    },
    ...
    resumeVideoProgress: function () {
      ...
      4 <= a.readyState && a.autoplay && !this.isMobile()
        ? (this.playVideo(), this.dispatchEvent({ type: "panolens-viewer-handler", method: "updateVideoPlayButton", data: !1 }))
        : (this.pauseVideo(), this.dispatchEvent({ type: "panolens-viewer-handler", method: "updateVideoPlayButton", data: !0 }));
    ...
    composePanorama: function () {
      ...
      for (var d = this._parameters.useWebGL, e = 0; e < b; e++)
        for (var k = {}, h = 0; h < a; k = { $jscomp$loop$prop$url$1: k.$jscomp$loop$prop$url$1 }, h++)
          (k.$jscomp$loop$prop$url$1 = "https://geo0.ggpht.com/cbk?cb_client=maps_sv.tactile&authuser=0&hl=en&output=tile&zoom=" + this._zoom + "&x=" + h + "&y=" + e + "&panoid=" + this._panoId + "&nbt&fover=2"),
            (function (a) {
              return function (b, e) {
                if (d)
  ...
  var ka = {
    uniforms: { tDiffuse: { value: new e.Texture() }, resolution: { value: 1 }, transform: { value: new e.Matrix4() }, zoom: { value: 1 }, opacity: { value: 1 } },
  ...
  C.prototype = Object.assign(Object.create(y.prototype), {
    ...
    createMaterial: function (a) {
      ...
      c.zoom.value = a;
      c.opacity.value = 0;
      return new e.ShaderMaterial({ uniforms: c, vertexShader: b.vertexShader, fragmentShader: b.fragmentShader, side: e.BackSide, transparent: !0 });
    },
  ...
  da.prototype = Object.assign(Object.create(e.EventDispatcher.prototype), {
    ...
    onMouseUp: function (a) {
      ...
      if (!a || !a.target || a.target.classList.contains("panolens-canvas"))
        if (
          (a.preventDefault(),
          (a = a.changedTouches && 1 === a.changedTouches.length ? this.onTap({ clientX: a.changedTouches[0].clientX, clientY: a.changedTouches[0].clientY }, b) : this.onTap(a, b)),
    ...
    onTap: function (a, b) {
      ...
      if (this.panorama) {
        ...
        "mouseup" === this.userMouse.type &&
          (d && this.pressEntityObject === d && this.pressEntityObject.dispatchEvent && this.pressEntityObject.dispatchEvent({ type: "pressstop-entity", mouseEvent: a }), (this.pressEntityObject = void 0));
        ...
        if ("click" === b)
          ...
          d &&
            ...
            (this.hoverObject !== d &&
              ...
              this.hoverObject.dispatchEvent &&
                (this.hoverObject.dispatchEvent({ type: "hoverenter", mouseEvent: a }), ((this.options.autoReticleSelect && this.options.enableReticle) || this.tempEnableReticle) && this.reticle.start(this.onTap.bind(this, a, "click")))),
            "mousedown" === this.userMouse.type && this.pressEntityObject != d && ((this.pressEntityObject = d), this.pressEntityObject.dispatchEvent && this.pressEntityObject.dispatchEvent({ type: "pressstart-entity", mouseEvent: a })),
            "mousedown" === this.userMouse.type && this.pressObject != e && ((this.pressObject = e), this.pressObject.dispatchEvent && this.pressObject.dispatchEvent({ type: "pressstart", mouseEvent: a })),
            "mousemove" === this.userMouse.type || this.options.enableReticle) &&
            (e && e.dispatchEvent && e.dispatchEvent({ type: "hover", mouseEvent: a }),
            this.pressEntityObject && this.pressEntityObject.dispatchEvent && this.pressEntityObject.dispatchEvent({ type: "pressmove-entity", mouseEvent: a }),
            this.pressObject && this.pressObject.dispatchEvent && this.pressObject.dispatchEvent({ type: "pressmove", mouseEvent: a }));
          ...
          !e && this.pressObject && this.pressObject.dispatchEvent && (this.pressObject.dispatchEvent({ type: "pressstop", mouseEvent: a }), (this.pressObject = void 0));
        }
        if (e && e instanceof z) {
        ...
        this.options.autoRotate &&
          ...
          (clearTimeout(this.autoRotateRequestId),
          this.control === this.OrbitControls && ((this.OrbitControls.autoRotate = !1), (this.autoRotateRequestId = window.setTimeout(this.enableAutoRate.bind(this), this.options.autoRotateActivationDuration))));
      }
    },
    ...
    render: function () {
      this.mode === t.CARDBOARD || this.mode === t.STEREO
        ? (this.renderer.clear(), this.effect.render(this.scene, this.camera), this.effect.render(this.sceneReticle, this.camera))
        : (this.renderer.clear(), this.renderer.render(this.scene, this.camera), this.renderer.clearDepth(), this.renderer.render(this.sceneReticle, this.camera));
    },
    animate: function () {
